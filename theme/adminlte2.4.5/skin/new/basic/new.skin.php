...
<section class="content">
  <div class="error-page">
	...
	<div class="error-content">
	  <h3><i class="fa fa-search text-aqua"></i> <strong> <?php echo $mb_id; ?></strong> 검색 결과</h3>

	  <!-- 전체검색 시작 { -->
	  <form name="fnew" method="get" class="search-form">
	  <input type="hidden" name="view" id="view" value="">
		
		<div class="input-group">
		  <input type="text" name="mb_id" id="mb_id" value="<?php echo $mb_id;?>" required class="form-control" placeholder="Search (회원 아이디만 검색 가능)">
...
<div class="tbl_head01 tbl_wrap col-xs-12">
    <table>
    <thead>
    <tr>
        <?php if ($is_admin) { ?>
